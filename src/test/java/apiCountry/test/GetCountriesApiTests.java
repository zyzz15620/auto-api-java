package apiCountry.test;

import apiCustomerManagement.common.RestAssuredSetUp;
import apiCountry.data.GetCountriesData;
import apiCountry.model.country.Country;
import apiCountry.model.country.CountryPagination;
...
import static apiCustomerManagement.common.MethodUtils.areListsDisjoint;
...
//    }
    ...
    void verifyGetCountriesPagination() {
        ...
        assertThat(areListsDisjoint(countryPaginationFirstPage.getData(), countryPaginationSecondPage.getData()), is(true));
